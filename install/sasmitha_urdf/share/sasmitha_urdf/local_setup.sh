...
: ${AMENT_CURRENT_PREFIX:="/urdf_ex/install/sasmitha_urdf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sasmitha_urdf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sasmitha_urdf/environment/path.sh"
